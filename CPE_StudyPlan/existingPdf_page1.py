...
#term2 terms
can.drawString(40,260, term2)
can.drawString(40,248, term2)
can.drawString(40,236, term2) 
can.drawString(40,222, term2)
can.drawString(40,210, term2)
can.drawString(40,198, term2)
can.drawString(40,186, term2)
can.drawString(40,172, term2)
...
#term3 terms
can.drawString(360,400, term3)
can.drawString(360,388, term3)
can.drawString(360,376, term3) 
can.drawString(360,364, term3)
can.drawString(360,352, term3)
can.drawString(360,340, term3)
...
#term4 term
can.drawString(360,260, term4)
can.drawString(360,248, term4)
can.drawString(360,236, term4) 
can.drawString(360,222, term4)
can.drawString(360,210, term4)
can.drawString(360,198, term4)
