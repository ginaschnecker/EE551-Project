...
#term5
can.drawString(40,432, terms[4])
can.drawString(40,422, terms[4])
can.drawString(40,410, terms[4])
can.drawString(40,398, terms[4])
can.drawString(40,386, terms[4])
can.drawString(40,374, terms[4])
...
#term6
can.drawString(40,340, terms[5])
can.drawString(40,325, terms[5])
can.drawString(40,312, terms[5])
can.drawString(40,300, terms[5])
can.drawString(40,288, terms[5])
can.drawString(40,276, terms[5])
can.drawString(40,264, terms[5])
...
#term7
can.drawString(360,432, terms[6])
can.drawString(360,422, terms[6])
can.drawString(360,410, terms[6])
can.drawString(360,398, terms[6])
can.drawString(360,386, terms[6])
can.drawString(360,374, terms[6])
...
#term8
can.drawString(360,340, terms[7])
can.drawString(360,325, terms[7])
can.drawString(360,312, terms[7])
can.drawString(360,300, terms[7])
can.drawString(360,288, terms[7])
can.drawString(360,276, terms[7])
...
#classes
can.drawString(125,410, Humanity[2])
can.drawString(150,288, Science[1])
can.drawString(110,276, General[0])
can.drawString(420,398, General[1])
can.drawString(475,386, Technical[0])
can.drawString(475,374, Technical[1])
can.drawString(475,325, Technical[2])
can.drawString(475,312, Technical[3])
can.drawString(450,300, Humanity[3])
can.drawString(420,288, General[2])
...
outputStream = file("/home/gschneck/projectPractice/EE_StudyPlan/newpdf_p2.pdf", "wb")
