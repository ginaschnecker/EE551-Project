...
#term2 terms
can.drawString(40,260, Science1_term)
can.drawString(40,248, ScienceLab1_term)
...
#term2 grades
can.drawString(295,260, Science1_grade)
can.drawString(295,248, ScienceLab1_grade)
...
can.drawString(360,340, Humanity1_term)
...
can.drawString(625,340, Humanity1_grade)
...
can.drawString(360,198, Humanity2_term)
...
can.drawString(625,198, Humanity2_grade)

#humanities
can.drawString(450,342, Humanity1)
can.drawString(450,198, Humanity2)

#science elective/lab
can.drawString(150,260, Science1)
can.drawString(175,248, ScienceLab1)
